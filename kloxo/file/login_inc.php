...
<div align="center">
	<div class="login">
		<div class="login-form">
		 	 ...
		 	 <form name="loginform" action="/htmllib/phplib/" onsubmit="ctrim(this.frm_clientname.value) ; ctrim(this.frm_password.value) ; encode_url(loginform) ; return fieldcheck(this)" method="post">
